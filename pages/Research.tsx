    ...
    <div className="flex flex-col lg:flex-row gap-8 h-[calc(100vh-8rem)]">
      ...
      <div className="flex-1 flex flex-col min-h-0 overflow-y-auto pr-2">
        <header className="mb-6">
            <h1 className="text-3xl font-bold text-white mb-2">Recherche & Sourcing International</h1>
        ...
        <div className="bg-dark-900 border border-slate-800 p-6 rounded-2xl mb-8 shadow-xl">
             ...
             <form onSubmit={handleSearch} className="relative">
                ...
                <input
                    ...
                    placeholder="Produit à analyser (Ex: Projecteur Galaxy, Correcteur de posture...)"
        ...
        <div className="flex-1">
            {error && (
                <div className="p-4 bg-red-900/30 border border-red-800 text-red-200 rounded-xl flex items-center gap-3 mb-6">
            ...
            {loading && (
                <div className="flex flex-col items-center justify-center py-20 space-y-4">
                    ...
                    <p className="text-slate-400 animate-pulse">Scan des marchés Internationaux en cours...</p>
            ...
            {!result && !loading && !error && (
                 <div className="grid grid-cols-1 md:grid-cols-2 gap-6 opacity-60">
                     <div className="p-6 bg-dark-900 border border-dashed border-slate-800 rounded-xl text-center">
                        ...
                        <h3 className="text-white font-medium">Comparaison Multi-Marchés</h3>
                        <p className="text-slate-500 text-sm">Obtenez un tableau comparatif Chine vs Europe vs USA.</p>
                     </div>
                     <div className="p-6 bg-dark-900 border border-dashed border-slate-800 rounded-xl text-center">
                         <Bookmark className="w-8 h-8 text-slate-600 mx-auto mb-2" />
                        <h3 className="text-white font-medium">Liens Directs</h3>
                        <p className="text-slate-500 text-sm">Accédez directement aux pages produits trouvées par l'IA.</p>
                     </div>
                 </div>
            )}
        </div>
